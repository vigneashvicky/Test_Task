...
import datetime
import Test_Task.task_app.jwt_file as jwt
...
def submit_fun(request):
    if request.method == 'POST':
        try:
            ...
            resp = requests.post("http://127.0.0.1:8001/ProcessPayment", params=params, data=datas, headers=headers,
                                 verify=False)
